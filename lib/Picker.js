...
export default class Picker extends Component {
        ...
        return arr.map((item, i) => {
            return (
                <View key={i} style={{height: 25, justifyContent: 'center', alignItems: 'center'}}>
                    <Text style={{fontSize: size == 'big' ? CSS.pixel(32) : CSS.pixel(22), color: size == 'big' ? '#fff' : '#7f7f7f', backgroundColor: 'rgba(0,0,0,0)'}}>
    ...
    render() {
        return (
            <View style = {{flex: 1}}>
                <View style = {{height: 225, backgroundColor: '#00BCD4', }}>
                    <ScrollView
                        bounces = {false}
                ...
                <View style = {{height: 28, marginTop: -125, backgroundColor: '#00BCD4', }} pointerEvents = 'none' >
